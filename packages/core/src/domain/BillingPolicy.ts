/**
 * @file packages/core/src/domain/BillingPolicy.ts
 *
 * =============================================================================
 * 💳 BILLING POLICY — ДОМЕННЫЕ ПОЛИТИКИ БИЛЛИНГА И ЛИМИТОВ
 * =============================================================================
 *
 ...
 *
 * Применение:
 * - Используется ТОЛЬКО в feature-billing effects
 * - Не вызывается напрямую из API / UI
 *
 * Принципы:
