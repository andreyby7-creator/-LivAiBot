...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_bots_workspace_id_id", "bots", ["workspace_id", "id"], unique=False
    )
    ...
    op.create_index(
        "ix_bot_versions_workspace_id", "bot_versions", ["workspace_id"], unique=False
    )
    op.create_index("ix_bot_versions_bot_id", "bot_versions", ["bot_id"], unique=False)
    op.create_index(
        "ix_bot_versions_workspace_bot",
        "bot_versions",
        ["workspace_id", "bot_id"],
        unique=False,
    )
