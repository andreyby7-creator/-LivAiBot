...
- ⚪ `bot-audit.ts` — ts — deps: domain/BotAuditEvent, schemas/index, types/bots — хелперы для логирования audit-событий (валидация через botAuditEventSchema, построение контекста, отправка в SIEM/логирование)
