...
- ⚪ `create/create-bot-audit.mapper.ts` — ts — deps: shared/audit.port, schemas/index, types/bots — построение audit-событий bot_created/bot_create_failed (вход для audit sink)
