...
2️⃣2️⃣6️⃣ effects/shared/auth-api.mappers.ts 🔴 — ts — deps: schemas, domain/TokenPair, domain/MeResponse; (общие мэпперы: mapTokenPairValuesToDomain, mapMeResponseValuesToDomain)
...
2️⃣3️⃣0️⃣ effects/login/login-api.mapper.ts 🟢 — ts — deps: domain/LoginRequest, domain/LoginResult, domain/MeResponse, domain/MfaChallengeRequest, domain/TokenPair, schemas, types/login.dto; (mapper: LoginRequest→LoginRequestValues, LoginResponseDto→DomainLoginResult, assertNever)
