...
2️⃣3️⃣7️⃣ effects/logout/logout-store-updater.ts 🔴 — ts — deps: effects/shared/auth-store.port, types/auth-initial; (applyLogoutReset: атомарный reset через batchUpdate, использует INITIAL_* states)
