...
export const DOMAIN_ERROR_CODES = {
  ...
  DOMAIN_USER_NOT_FOUND: 'DOMAIN_USER_100' as const,
  DOMAIN_USER_ALREADY_EXISTS: 'DOMAIN_USER_101' as const,
  DOMAIN_USER_INVALID_DATA: 'DOMAIN_USER_102' as const,
  DOMAIN_USER_EMAIL_NOT_VERIFIED: 'DOMAIN_USER_103' as const,
  DOMAIN_USER_PHONE_NOT_VERIFIED: 'DOMAIN_USER_104' as const,
  DOMAIN_USER_PROFILE_INCOMPLETE: 'DOMAIN_USER_105' as const,

  // Subscriptions (200-299)
  DOMAIN_SUBSCRIPTION_NOT_FOUND: 'DOMAIN_SUBSCRIPTION_200' as const,
  DOMAIN_SUBSCRIPTION_EXPIRED: 'DOMAIN_SUBSCRIPTION_201' as const,
  DOMAIN_SUBSCRIPTION_LIMIT_EXCEEDED: 'DOMAIN_SUBSCRIPTION_202' as const,
  DOMAIN_SUBSCRIPTION_PAYMENT_REQUIRED: 'DOMAIN_SUBSCRIPTION_203' as const,
  DOMAIN_SUBSCRIPTION_PLAN_NOT_AVAILABLE: 'DOMAIN_SUBSCRIPTION_204' as const,

  // Bot Operations (300-399)
  DOMAIN_BOT_NOT_FOUND: 'DOMAIN_BOT_300' as const,
  DOMAIN_BOT_ALREADY_EXISTS: 'DOMAIN_BOT_301' as const,
  DOMAIN_BOT_INVALID_CONFIGURATION: 'DOMAIN_BOT_302' as const,
  DOMAIN_BOT_PROCESSING_FAILED: 'DOMAIN_BOT_303' as const,
  DOMAIN_BOT_RATE_LIMIT_EXCEEDED: 'DOMAIN_BOT_304' as const,

  // Integrations (400-499)
  DOMAIN_INTEGRATION_NOT_FOUND: 'DOMAIN_INTEGRATION_400' as const,
  DOMAIN_INTEGRATION_INVALID_CONFIG: 'DOMAIN_INTEGRATION_401' as const,
  DOMAIN_INTEGRATION_CONNECTION_FAILED: 'DOMAIN_INTEGRATION_402' as const,
  DOMAIN_INTEGRATION_RATE_LIMIT: 'DOMAIN_INTEGRATION_403' as const,
  DOMAIN_INTEGRATION_AUTH_FAILED: 'DOMAIN_INTEGRATION_404' as const,

  // Tokens (500-599)
  DOMAIN_TOKEN_INVALID: 'DOMAIN_TOKEN_500' as const,
  DOMAIN_TOKEN_EXPIRED: 'DOMAIN_TOKEN_501' as const,
  DOMAIN_TOKEN_REVOKED: 'DOMAIN_TOKEN_502' as const,
  DOMAIN_TOKEN_INSUFFICIENT_SCOPES: 'DOMAIN_TOKEN_503' as const,

  // Billing (600-699)
  DOMAIN_BILLING_PAYMENT_FAILED: 'DOMAIN_BILLING_600' as const,
  DOMAIN_BILLING_INVALID_AMOUNT: 'DOMAIN_BILLING_601' as const,
  DOMAIN_BILLING_CURRENCY_NOT_SUPPORTED: 'DOMAIN_BILLING_602' as const,
  DOMAIN_BILLING_REFUND_FAILED: 'DOMAIN_BILLING_603' as const,

  // Tenants (700-799)
  DOMAIN_TENANT_NOT_FOUND: 'DOMAIN_TENANT_700' as const,
  DOMAIN_TENANT_LIMIT_EXCEEDED: 'DOMAIN_TENANT_701' as const,
  DOMAIN_TENANT_SUSPENDED: 'DOMAIN_TENANT_702' as const,

  // Features (800-899)
  DOMAIN_FEATURE_NOT_AVAILABLE: 'DOMAIN_FEATURE_800' as const,
  DOMAIN_FEATURE_DISABLED: 'DOMAIN_FEATURE_801' as const,
  DOMAIN_FEATURE_QUOTA_EXCEEDED: 'DOMAIN_FEATURE_802' as const,

  // Finance (900-999)
  DOMAIN_FINANCE_TRANSACTION_FAILED: 'DOMAIN_FINANCE_900' as const,
  DOMAIN_FINANCE_INSUFFICIENT_FUNDS: 'DOMAIN_FINANCE_901' as const,
  DOMAIN_FINANCE_ACCOUNT_FROZEN: 'DOMAIN_FINANCE_902' as const,

  // Audit (1000-1099)
  DOMAIN_AUDIT_LOG_FAILED: 'DOMAIN_AUDIT_1000' as const,
  DOMAIN_AUDIT_ACCESS_DENIED: 'DOMAIN_AUDIT_1001' as const,
} as const;
...
export const INFRA_ERROR_CODES = {
  ...
  INFRA_DB_QUERY_FAILED: 'INFRA_DB_002' as const,
  INFRA_DB_TRANSACTION_FAILED: 'INFRA_DB_003' as const,
  INFRA_DB_CONNECTION_TIMEOUT: 'INFRA_DB_004' as const,
  INFRA_DB_DEADLOCK: 'INFRA_DB_005' as const,

  // Cache (100-199)
  INFRA_CACHE_CONNECTION_FAILED: 'INFRA_CACHE_100' as const,
  INFRA_CACHE_SET_FAILED: 'INFRA_CACHE_101' as const,
  INFRA_CACHE_GET_FAILED: 'INFRA_CACHE_102' as const,
  INFRA_CACHE_DELETE_FAILED: 'INFRA_CACHE_103' as const,

  // Network (200-299)
  INFRA_NETWORK_TIMEOUT: 'INFRA_NETWORK_200' as const,
  INFRA_NETWORK_CONNECTION_REFUSED: 'INFRA_NETWORK_201' as const,
  INFRA_NETWORK_DNS_FAILED: 'INFRA_NETWORK_202' as const,
  INFRA_NETWORK_SSL_ERROR: 'INFRA_NETWORK_203' as const,

  // External Services (300-399)
  INFRA_EXTERNAL_API_UNAVAILABLE: 'INFRA_EXTERNAL_300' as const,
...
export const SERVICE_ERROR_CODES = {
  ...
  SERVICE_AI_PROCESSING_FAILED: 'SERVICE_AI_002' as const,
  SERVICE_AI_INVALID_INPUT: 'SERVICE_AI_003' as const,
  SERVICE_AI_RATE_LIMIT_EXCEEDED: 'SERVICE_AI_004' as const,
  SERVICE_AI_MODEL_TIMEOUT: 'SERVICE_AI_005' as const,
  SERVICE_AI_MODEL_LOAD_FAILED: 'SERVICE_AI_006' as const,
  SERVICE_AI_INFERENCE_ERROR: 'SERVICE_AI_007' as const,
  SERVICE_AI_TOKEN_LIMIT_EXCEEDED: 'SERVICE_AI_008' as const,
  SERVICE_AI_PROMPT_VALIDATION_FAILED: 'SERVICE_AI_009' as const,
  SERVICE_AI_CONTEXT_OVERFLOW: 'SERVICE_AI_010' as const,

  // Billing Service (100-199)
  SERVICE_BILLING_PAYMENT_FAILED: 'SERVICE_BILLING_100' as const,
  SERVICE_BILLING_SUBSCRIPTION_ERROR: 'SERVICE_BILLING_101' as const,
  SERVICE_BILLING_REFUND_ERROR: 'SERVICE_BILLING_102' as const,
  SERVICE_BILLING_PAYMENT_VALIDATION_FAILED: 'SERVICE_BILLING_103' as const,
  SERVICE_BILLING_SUBSCRIPTION_LIMIT_EXCEEDED: 'SERVICE_BILLING_104' as const,
  SERVICE_BILLING_REFUND_POLICY_VIOLATION: 'SERVICE_BILLING_105' as const,
  SERVICE_BILLING_WEBPAY_API_ERROR: 'SERVICE_BILLING_106' as const,
  SERVICE_BILLING_BEPAID_API_ERROR: 'SERVICE_BILLING_107' as const,
  SERVICE_BILLING_GATEWAY_UNAVAILABLE: 'SERVICE_BILLING_108' as const,
  SERVICE_BILLING_GENERIC_API_ERROR: 'SERVICE_BILLING_109' as const,
} as const;
...
export const ADMIN_ERROR_CODES = {
  ...
  ADMIN_USER_ACCESS_DENIED: 'ADMIN_USER_002' as const,
  ADMIN_USER_INSUFFICIENT_PRIVILEGES: 'ADMIN_USER_003' as const,

  // System Operations (100-199)
  ADMIN_SYSTEM_MAINTENANCE: 'ADMIN_SYSTEM_100' as const,
  ADMIN_SYSTEM_BACKUP_FAILED: 'ADMIN_SYSTEM_101' as const,
  ADMIN_SYSTEM_UPDATE_FAILED: 'ADMIN_SYSTEM_102' as const,

  // Configuration (200-299)
  ADMIN_CONFIG_INVALID: 'ADMIN_CONFIG_200' as const,
  ADMIN_CONFIG_SAVE_FAILED: 'ADMIN_CONFIG_201' as const,
  ADMIN_CONFIG_LOAD_FAILED: 'ADMIN_CONFIG_202' as const,
} as const;
