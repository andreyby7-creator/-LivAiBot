...
const DOMAIN_SUBSCRIPTION_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_SUBSCRIPTION_NOT_FOUND,
  LIVAI_ERROR_CODES.DOMAIN_SUBSCRIPTION_EXPIRED,
];

const DOMAIN_BOT_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_BOT_NOT_FOUND,
  LIVAI_ERROR_CODES.DOMAIN_BOT_ALREADY_EXISTS,
];

const DOMAIN_TOKEN_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_TOKEN_INVALID,
  LIVAI_ERROR_CODES.DOMAIN_TOKEN_EXPIRED,
];

const DOMAIN_INTEGRATION_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_INTEGRATION_NOT_FOUND,
  LIVAI_ERROR_CODES.DOMAIN_INTEGRATION_INVALID_CONFIG,
];

const INFRA_DB_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.INFRA_DB_CONNECTION_FAILED,
  LIVAI_ERROR_CODES.INFRA_DB_QUERY_FAILED,
  LIVAI_ERROR_CODES.INFRA_DB_TRANSACTION_FAILED,
];
...
const INFRA_NETWORK_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.INFRA_NETWORK_TIMEOUT,
  LIVAI_ERROR_CODES.INFRA_NETWORK_CONNECTION_REFUSED,
];

const INFRA_EXTERNAL_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.INFRA_EXTERNAL_API_UNAVAILABLE,
  LIVAI_ERROR_CODES.INFRA_EXTERNAL_API_TIMEOUT,
];

const SERVICE_AI_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.SERVICE_AI_MODEL_UNAVAILABLE,
  LIVAI_ERROR_CODES.SERVICE_AI_PROCESSING_FAILED,
  LIVAI_ERROR_CODES.SERVICE_AI_INVALID_INPUT,
];

const SERVICE_BILLING_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_BILLING_PAYMENT_FAILED,
  LIVAI_ERROR_CODES.DOMAIN_BILLING_INVALID_AMOUNT,
];

const SERVICE_MOBILE_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_USER_NOT_FOUND,
  LIVAI_ERROR_CODES.DOMAIN_USER_INVALID_DATA,
];

const SERVICE_TENANT_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_TENANT_NOT_FOUND,
  LIVAI_ERROR_CODES.DOMAIN_TENANT_LIMIT_EXCEEDED,
];

const SERVICE_FEATURE_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_FEATURE_NOT_AVAILABLE,
  LIVAI_ERROR_CODES.DOMAIN_FEATURE_DISABLED,
];

const ADMIN_USER_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.ADMIN_USER_NOT_FOUND,
  LIVAI_ERROR_CODES.ADMIN_USER_ACCESS_DENIED,
];

const ADMIN_FINANCE_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_FINANCE_TRANSACTION_FAILED,
  LIVAI_ERROR_CODES.DOMAIN_FINANCE_INSUFFICIENT_FUNDS,
];

const ADMIN_AUDIT_CODES: readonly LivAiErrorCode[] = [
  LIVAI_ERROR_CODES.DOMAIN_AUDIT_LOG_FAILED,
  LIVAI_ERROR_CODES.DOMAIN_AUDIT_ACCESS_DENIED,
];
